...
- Managing external contributors and contractors - compensation, vesting allocation, transition into CC's 
...
The Core Contributor Committee will be made up of three members of the Core Contributors, elected by Core Contributors. This committee decides (via a ⅔ majority) on a variety of decisions:
...
During these half-yearly reviews, the CCC will need to coordinate with the Treasury Council to adjust the CC budget.
